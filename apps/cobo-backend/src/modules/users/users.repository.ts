...
export class UsersRepository {
	constructor(private prismaService: PrismaService, private bcryptService: BCryptService) {}
	...
	async updateOne(user: User, update: User): Promise<any> {
		try {
			...
			throw new BadRequestException('Noe gikk galt under oppdatering av bruker');
		}
	}
}
